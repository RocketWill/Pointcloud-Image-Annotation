...
function points3d_homo_to_image2d(points3d, calib, accept_partial=false,save_map, img_dx, img_dy){
    ...
    console.log("🤡 ~ file: image.js ~ line 1108 ~ points3d_homo_to_image2d ~ imgfinal", imgfinal)
    ...
    if (accept_partial){
        ...
        console.log("🤡 ~ file: image.js ~ line 1147 ~ points3d_homo_to_image2d ~ imgfinal", imgfinal)
